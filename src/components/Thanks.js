    ...
    return (
      <div className="ui grid container">
        <div className="ui one column grid">
          <div className="first header"><h1 className="thanks">Thank you for using to Sherlock Homes, {this.props.currentUser.name.split(" ")[0]}</h1>
          <p>We are thrilled that we could help you find your next roommate!</p>
          <div>
            <img src="../../public/image/sherlock-thanks-you.jpg" />
          </div>
